...
function Pi(; host = get(ENV, "PIGPIO_ADDR", ""), port = get(ENV, "PIGPIO_PORT", 8888))
    ...
    try
        ...
        println(Core.stdout, "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
        println(Core.stdout, "Can't connect to pigpio at $host:$port")
        println(Core.stdout, "Did you start the pigpio daemon? E.g. sudo pigpiod\n")
        println(Core.stdout, "Did you specify the correct Pi host/port in the environment")
        println(Core.stdout, "variables PIGPIO_ADDR/PIGPIO_PORT?")
        println(Core.stdout, "E.g. export PIGPIO_ADDR=soft, export PIGPIO_PORT=8888\n")
        println(Core.stdout, "Did you specify the correct Pi host/port in the")
        println(Core.stdout, "Pi() function? E.g. Pi('soft', 8888))")
        println(Core.stdout, "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
        throw(error)
    end
end
